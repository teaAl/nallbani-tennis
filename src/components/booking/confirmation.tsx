...
const BookingConfirmation = () => {
    ...
    return (
        <div className="flex flex-col gap-6 w-full">
            <h3 className="font-poppins text-xl text-pink-300 w-full border-b border-b-pink-300 border-opacity-10 py-4">Please confirm your booking</h3>
            <div className="flex flex-row justify-between gap-6 w-full cursor-pointer">
                <div className="w-full h-full relative">
                    ...
                    <div className="bg-white bg-opacity-10 rounded-md gap-2 w-full h-auto flex flex-col items-center">
                        ...
                        <div className="flex flex-row justify-between w-full px-4 pb-2">
                ...
                <div className="w-full h-full text-white flex flex-col gap-6 p-6">
                    <div className="flex flex-row gap-4 border-b border-green-300 border-opacity-10 pb-4">
