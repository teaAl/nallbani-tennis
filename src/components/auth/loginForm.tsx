...
export default function LoginForm() {
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center h-screen bg-[linear-gradient(to_bottom_left,rgba(16,24,40,0.9),rgba(16,24,40,1)),url('/images/ballsbasket.png')] bg-cover bg-no-repeat bg-bottom`}
    >
      <Image
      ...
      <div className="w-1/3 flex flex-col items-center justify-center gap-10">
        <h1 className="text-pear text-4xl font-poppins font-bold text-shadow-2xs">
          Welcome to Nallbani Tennis Club!
        </h1>
