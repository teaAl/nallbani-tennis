      ...
      <Tabs defaultValue="connections">
        ...
        <TabsContent value="connections" className="mt-4">
          {filteredConnections.length === 0 ? (
            <div className="text-center py-10 text-foreground">No connections found</div>
          ) : (
                  ...
                  <CardContent className="p-0">
                    <div className="flex items-start p-4">
                      <div className="relative mr-4">
                        ...
                        <div
                          className={`absolute -bottom-1 right-1 h-3 w-3 rounded-full border-2 border-gray-900 ${connection.status === "online" ? "bg-pear" : "bg-foreground"}`}
                        />
                      </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <div className="flex items-center text-sm text-foreground/60">
                              <span className="text-pear/60">{connection.level}</span>
