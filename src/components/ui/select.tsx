...
export function Select({ defaultValue, value, onValueChange, className, children, ...props }: SelectProps) {
...
export function SelectTrigger({ className, selectedValue, isOpen, setIsOpen, children, ...props }: SelectTriggerProps) {
  return (
    <button
      type="button"
      className={cn(
...
export function SelectValue({ className, placeholder, selectedValue, ...props }: SelectValueProps) {
  return (
    <span className={cn("text-sm", !selectedValue && "text-gray-400", className)} {...props}>
...
export function SelectContent({ className, isOpen, children, ...props }: SelectContentProps) {
...
export function SelectItem({ className, value, selectedValue, onValueChange, children, ...props }: SelectItemProps) {
