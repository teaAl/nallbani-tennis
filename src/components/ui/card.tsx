...
const Card = ({
    ...
    return (
        <>
            ...
            ${isMember ? "bg-[linear-gradient(to_right,rgba(205,220,59,0.8),rgba(205,220,59,0.2)),url('/images/membershipcards.svg')] bg-no-repeat bg-right-bottom" : "bg-[linear-gradient(to_right,rgba(30,41,57,1),rgba(205,220,59,0.3)),url('/images/court.png')] bg-no-repeat bg-right-bottom"}`}>
                {/* Symbol at the top */}
