	...
	return (
		<div className="bg-gradient-to-r from-pear via-gray-800 to-gray-800">
			<div className={`p-6
				...
				ref={bannerRef}
			>
				<div className="w-full rounded-2xl shadow-[-17px_-15px_0px_0px_#10182840] md:h-[calc(100vh-20rem)] h-[calc(100vh-40rem)] bg-[linear-gradient(to_bottom,rgba(16,24,40,0.7),rgba(16,24,40,1)),url('/images/racketballsnet.jpg')] bg-cover /*bg-fixed*/ bg-center ">
